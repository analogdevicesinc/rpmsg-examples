...
#ifndef __ADI_SPORT_CONFIG_SC59X_H__
...
#define ADI_SPORT_0A_CTL                                       \
	((ADI_SPORT0A_CTL_DTYPE << BITP_SPORT_CTL_A_DTYPE) |   \
	 (ADI_SPORT0A_CTL_LSBF << BITP_SPORT_CTL_A_LSBF) |     \
	 (ADI_SPORT0A_CTL_SLEN << BITP_SPORT_CTL_A_SLEN) |     \
	 (ADI_SPORT0A_CTL_PACK << BITP_SPORT_CTL_A_PACK) |     \
	 (ADI_SPORT0A_CTL_ICLK << BITP_SPORT_CTL_A_ICLK) |     \
	 (ADI_SPORT0A_CTL_OPMODE << BITP_SPORT_CTL_A_OPMODE) | \
	 (ADI_SPORT0A_CTL_CKRE << BITP_SPORT_CTL_A_CKRE) |     \
	 (ADI_SPORT0A_CTL_FSR << BITP_SPORT_CTL_A_FSR) |       \
	 (ADI_SPORT0A_CTL_IFS << BITP_SPORT_CTL_A_IFS) |       \
	 (ADI_SPORT0A_CTL_DIFS << BITP_SPORT_CTL_A_DIFS) |     \
	 (ADI_SPORT0A_CTL_LFS << BITP_SPORT_CTL_A_LFS) |       \
	 (ADI_SPORT0A_CTL_LAFS << BITP_SPORT_CTL_A_LAFS) |     \
	 (ADI_SPORT0A_CTL_RJUST << BITP_SPORT_CTL_A_RJUST) |   \
	 (ADI_SPORT0A_CTL_FSED << BITP_SPORT_CTL_A_FSED) |     \
	 (ADI_SPORT0A_CTL_GCLKEN << BITP_SPORT_CTL_A_GCLKEN) | \
	 (ADI_SPORT0A_CTL_SPTRAN << BITP_SPORT_CTL_A_SPTRAN))
...
#define ADI_SPORT_0A_DIV                                       \
	((ADI_SPORT0A_DIV_CLKDIV << BITP_SPORT_DIV_A_CLKDIV) | \
	 (ADI_SPORT0A_DIV_FSDIV << BITP_SPORT_DIV_A_FSDIV))
...
#define ADI_SPORT_0A_MCTL                                      \
	((ADI_SPORT0A_MCTL_MCE << BITP_SPORT_MCTL_A_MCE) |     \
	 (ADI_SPORT0A_MCTL_MCPDE << BITP_SPORT_MCTL_A_MCPDE) | \
	 (ADI_SPORT0A_MCTL_MFD << BITP_SPORT_MCTL_A_MFD) |     \
	 (ADI_SPORT0A_MCTL_WSIZE << BITP_SPORT_MCTL_A_WSIZE) | \
	 (ADI_SPORT0A_MCTL_WOFFSET << BITP_SPORT_MCTL_A_WOFFSET))
...
#define ADI_SPORT_0B_CTL                                       \
	((ADI_SPORT0B_CTL_DTYPE << BITP_SPORT_CTL_B_DTYPE) |   \
	 (ADI_SPORT0B_CTL_LSBF << BITP_SPORT_CTL_B_LSBF) |     \
	 (ADI_SPORT0B_CTL_SLEN << BITP_SPORT_CTL_B_SLEN) |     \
	 (ADI_SPORT0B_CTL_PACK << BITP_SPORT_CTL_B_PACK) |     \
	 (ADI_SPORT0B_CTL_ICLK << BITP_SPORT_CTL_B_ICLK) |     \
	 (ADI_SPORT0B_CTL_OPMODE << BITP_SPORT_CTL_B_OPMODE) | \
	 (ADI_SPORT0B_CTL_CKRE << BITP_SPORT_CTL_B_CKRE) |     \
	 (ADI_SPORT0B_CTL_FSR << BITP_SPORT_CTL_B_FSR) |       \
	 (ADI_SPORT0B_CTL_IFS << BITP_SPORT_CTL_B_IFS) |       \
	 (ADI_SPORT0B_CTL_DIFS << BITP_SPORT_CTL_B_DIFS) |     \
	 (ADI_SPORT0B_CTL_LFS << BITP_SPORT_CTL_B_LFS) |       \
	 (ADI_SPORT0B_CTL_LAFS << BITP_SPORT_CTL_B_LAFS) |     \
	 (ADI_SPORT0B_CTL_RJUST << BITP_SPORT_CTL_B_RJUST) |   \
	 (ADI_SPORT0B_CTL_FSED << BITP_SPORT_CTL_B_FSED) |     \
	 (ADI_SPORT0B_CTL_GCLKEN << BITP_SPORT_CTL_B_GCLKEN) | \
...
#define ADI_SPORT_0B_DIV                                       \
	((ADI_SPORT0B_DIV_CLKDIV << BITP_SPORT_DIV_B_CLKDIV) | \
	 (ADI_SPORT0B_DIV_FSDIV << BITP_SPORT_DIV_B_FSDIV))
...
#define ADI_SPORT_0B_MCTL                                      \
	((ADI_SPORT0B_MCTL_MCE << BITP_SPORT_MCTL_B_MCE) |     \
	 (ADI_SPORT0B_MCTL_MCPDE << BITP_SPORT_MCTL_B_MCPDE) | \
	 (ADI_SPORT0B_MCTL_MFD << BITP_SPORT_MCTL_B_MFD) |     \
	 (ADI_SPORT0B_MCTL_WSIZE << BITP_SPORT_MCTL_B_WSIZE) | \
	 (ADI_SPORT0B_MCTL_WOFFSET << BITP_SPORT_MCTL_B_WOFFSET))
...
#define ADI_SPORT_1A_CTL                                       \
	((ADI_SPORT1A_CTL_DTYPE << BITP_SPORT_CTL_A_DTYPE) |   \
	 (ADI_SPORT1A_CTL_LSBF << BITP_SPORT_CTL_A_LSBF) |     \
	 (ADI_SPORT1A_CTL_SLEN << BITP_SPORT_CTL_A_SLEN) |     \
	 (ADI_SPORT1A_CTL_PACK << BITP_SPORT_CTL_A_PACK) |     \
	 (ADI_SPORT1A_CTL_ICLK << BITP_SPORT_CTL_A_ICLK) |     \
	 (ADI_SPORT1A_CTL_OPMODE << BITP_SPORT_CTL_A_OPMODE) | \
	 (ADI_SPORT1A_CTL_CKRE << BITP_SPORT_CTL_A_CKRE) |     \
	 (ADI_SPORT1A_CTL_FSR << BITP_SPORT_CTL_A_FSR) |       \
	 (ADI_SPORT1A_CTL_IFS << BITP_SPORT_CTL_A_IFS) |       \
	 (ADI_SPORT1A_CTL_DIFS << BITP_SPORT_CTL_A_DIFS) |     \
	 (ADI_SPORT1A_CTL_LFS << BITP_SPORT_CTL_A_LFS) |       \
	 (ADI_SPORT1A_CTL_LAFS << BITP_SPORT_CTL_A_LAFS) |     \
	 (ADI_SPORT1A_CTL_RJUST << BITP_SPORT_CTL_A_RJUST) |   \
	 (ADI_SPORT1A_CTL_FSED << BITP_SPORT_CTL_A_FSED) |     \
	 (ADI_SPORT1A_CTL_GCLKEN << BITP_SPORT_CTL_A_GCLKEN) | \
	 (ADI_SPORT1A_CTL_SPTRAN << BITP_SPORT_CTL_A_SPTRAN))
...
#define ADI_SPORT_1A_DIV                                       \
	((ADI_SPORT1A_DIV_CLKDIV << BITP_SPORT_DIV_A_CLKDIV) | \
	 (ADI_SPORT1A_DIV_FSDIV << BITP_SPORT_DIV_A_FSDIV))
...
#define ADI_SPORT_1A_MCTL                                      \
	((ADI_SPORT1A_MCTL_MCE << BITP_SPORT_MCTL_A_MCE) |     \
	 (ADI_SPORT1A_MCTL_MCPDE << BITP_SPORT_MCTL_A_MCPDE) | \
	 (ADI_SPORT1A_MCTL_MFD << BITP_SPORT_MCTL_A_MFD) |     \
	 (ADI_SPORT1A_MCTL_WSIZE << BITP_SPORT_MCTL_A_WSIZE) | \
	 (ADI_SPORT1A_MCTL_WOFFSET << BITP_SPORT_MCTL_A_WOFFSET))
...
#define ADI_SPORT_1B_CTL                                       \
	((ADI_SPORT1B_CTL_DTYPE << BITP_SPORT_CTL_B_DTYPE) |   \
	 (ADI_SPORT1B_CTL_LSBF << BITP_SPORT_CTL_B_LSBF) |     \
	 (ADI_SPORT1B_CTL_SLEN << BITP_SPORT_CTL_B_SLEN) |     \
	 (ADI_SPORT1B_CTL_PACK << BITP_SPORT_CTL_B_PACK) |     \
	 (ADI_SPORT1B_CTL_ICLK << BITP_SPORT_CTL_B_ICLK) |     \
	 (ADI_SPORT1B_CTL_OPMODE << BITP_SPORT_CTL_B_OPMODE) | \
	 (ADI_SPORT1B_CTL_CKRE << BITP_SPORT_CTL_B_CKRE) |     \
	 (ADI_SPORT1B_CTL_FSR << BITP_SPORT_CTL_B_FSR) |       \
	 (ADI_SPORT1B_CTL_IFS << BITP_SPORT_CTL_B_IFS) |       \
	 (ADI_SPORT1B_CTL_DIFS << BITP_SPORT_CTL_B_DIFS) |     \
	 (ADI_SPORT1B_CTL_LFS << BITP_SPORT_CTL_B_LFS) |       \
	 (ADI_SPORT1B_CTL_LAFS << BITP_SPORT_CTL_B_LAFS) |     \
	 (ADI_SPORT1B_CTL_RJUST << BITP_SPORT_CTL_B_RJUST) |   \
	 (ADI_SPORT1B_CTL_FSED << BITP_SPORT_CTL_B_FSED) |     \
	 (ADI_SPORT1B_CTL_GCLKEN << BITP_SPORT_CTL_B_GCLKEN) | \
	 (ADI_SPORT1B_CTL_SPTRAN << BITP_SPORT_CTL_B_SPTRAN))
...
#define ADI_SPORT_1B_DIV                                       \
	((ADI_SPORT1B_DIV_CLKDIV << BITP_SPORT_DIV_B_CLKDIV) | \
	 (ADI_SPORT1B_DIV_FSDIV << BITP_SPORT_DIV_B_FSDIV))
...
#define ADI_SPORT_1B_MCTL                                      \
	((ADI_SPORT1B_MCTL_MCE << BITP_SPORT_MCTL_B_MCE) |     \
	 (ADI_SPORT1B_MCTL_MCPDE << BITP_SPORT_MCTL_B_MCPDE) | \
	 (ADI_SPORT1B_MCTL_MFD << BITP_SPORT_MCTL_B_MFD) |     \
	 (ADI_SPORT1B_MCTL_WSIZE << BITP_SPORT_MCTL_B_WSIZE) | \
	 (ADI_SPORT1B_MCTL_WOFFSET << BITP_SPORT_MCTL_B_WOFFSET))
...
#define ADI_SPORT_2A_CTL                                                             \
	((ADI_SPORT2A_CTL_DTYPE << BITP_SPORT_CTL_A_DTYPE) |                         \
	 (ADI_SPORT2A_CTL_LSBF << BITP_SPORT_CTL_A_LSBF) |                           \
	 (ADI_SPORT2A_CTL_SLEN << BITP_SPORT_CTL_A_SLEN) |                           \
	 (ADI_SPORT2A_CTL_PACK << BITP_SPORT_CTL_A_PACK) |                           \
	 (ADI_SPORT2A_CTL_ICLK << BITP_SPORT_CTL_A_ICLK) |                           \
	 (ADI_SPORT2A_CTL_OPMODE << BITP_SPORT_CTL_A_OPMODE) |                       \
	 (ADI_SPORT2A_CTL_CKRE                                                       \
	  << BITP_SPORT_CTL_A_CKRE) /*|(ADI_SPORT2A_CTL_FSR<<BITP_SPORT_CTL_A_FSR)*/ \
	 | (ADI_SPORT2A_CTL_IFS << BITP_SPORT_CTL_A_IFS) |                           \
	 (ADI_SPORT2A_CTL_DIFS << BITP_SPORT_CTL_A_DIFS) |                           \
	 (ADI_SPORT2A_CTL_LFS << BITP_SPORT_CTL_A_LFS) |                             \
	 (ADI_SPORT2A_CTL_LAFS << BITP_SPORT_CTL_A_LAFS) |                           \
	 (ADI_SPORT2A_CTL_RJUST << BITP_SPORT_CTL_A_RJUST) |                         \
	 (ADI_SPORT2A_CTL_FSED << BITP_SPORT_CTL_A_FSED) |                           \
	 (ADI_SPORT2A_CTL_GCLKEN << BITP_SPORT_CTL_A_GCLKEN) |                       \
	 (ADI_SPORT2A_CTL_SPTRAN << BITP_SPORT_CTL_A_SPTRAN))
...
#define ADI_SPORT_2A_DIV                                       \
	((ADI_SPORT2A_DIV_CLKDIV << BITP_SPORT_DIV_A_CLKDIV) | \
	 (ADI_SPORT2A_DIV_FSDIV << BITP_SPORT_DIV_A_FSDIV))
...
#define ADI_SPORT_2A_MCTL                                      \
	((ADI_SPORT2A_MCTL_MCE << BITP_SPORT_MCTL_A_MCE) |     \
	 (ADI_SPORT2A_MCTL_MCPDE << BITP_SPORT_MCTL_A_MCPDE) | \
	 (ADI_SPORT2A_MCTL_MFD << BITP_SPORT_MCTL_A_MFD) |     \
	 (ADI_SPORT2A_MCTL_WSIZE << BITP_SPORT_MCTL_A_WSIZE) | \
	 (ADI_SPORT2A_MCTL_WOFFSET << BITP_SPORT_MCTL_A_WOFFSET))
...
#define ADI_SPORT_2B_CTL                                                             \
	((ADI_SPORT2B_CTL_DTYPE << BITP_SPORT_CTL_B_DTYPE) |                         \
	 (ADI_SPORT2B_CTL_LSBF << BITP_SPORT_CTL_B_LSBF) |                           \
	 (ADI_SPORT2B_CTL_SLEN << BITP_SPORT_CTL_B_SLEN) |                           \
	 (ADI_SPORT2B_CTL_PACK << BITP_SPORT_CTL_B_PACK) |                           \
	 (ADI_SPORT2B_CTL_ICLK << BITP_SPORT_CTL_B_ICLK) |                           \
	 (ADI_SPORT2B_CTL_OPMODE << BITP_SPORT_CTL_B_OPMODE) |                       \
	 (ADI_SPORT2B_CTL_CKRE                                                       \
	  << BITP_SPORT_CTL_B_CKRE) /*|(ADI_SPORT2B_CTL_FSR<<BITP_SPORT_CTL_B_FSR)*/ \
	 | (ADI_SPORT2B_CTL_IFS << BITP_SPORT_CTL_B_IFS) |                           \
	 (ADI_SPORT2B_CTL_DIFS << BITP_SPORT_CTL_B_DIFS) |                           \
	 (ADI_SPORT2B_CTL_LFS << BITP_SPORT_CTL_B_LFS) |                             \
	 (ADI_SPORT2B_CTL_LAFS << BITP_SPORT_CTL_B_LAFS) |                           \
	 (ADI_SPORT2B_CTL_RJUST << BITP_SPORT_CTL_B_RJUST) |                         \
	 (ADI_SPORT2B_CTL_FSED << BITP_SPORT_CTL_B_FSED) |                           \
	 (ADI_SPORT2B_CTL_GCLKEN << BITP_SPORT_CTL_B_GCLKEN) |                       \
	 (ADI_SPORT2B_CTL_SPTRAN << BITP_SPORT_CTL_B_SPTRAN))
...
#define ADI_SPORT_2B_DIV                                       \
	((ADI_SPORT2B_DIV_CLKDIV << BITP_SPORT_DIV_B_CLKDIV) | \
	 (ADI_SPORT2B_DIV_FSDIV << BITP_SPORT_DIV_B_FSDIV))
...
#define ADI_SPORT_2B_MCTL                                      \
	((ADI_SPORT2B_MCTL_MCE << BITP_SPORT_MCTL_B_MCE) |     \
	 (ADI_SPORT2B_MCTL_MCPDE << BITP_SPORT_MCTL_B_MCPDE) | \
	 (ADI_SPORT2B_MCTL_MFD << BITP_SPORT_MCTL_B_MFD) |     \
	 (ADI_SPORT2B_MCTL_WSIZE << BITP_SPORT_MCTL_B_WSIZE) | \
	 (ADI_SPORT2B_MCTL_WOFFSET << BITP_SPORT_MCTL_B_WOFFSET))
...
#define ADI_SPORT_3A_CTL                                                             \
	((ADI_SPORT3A_CTL_DTYPE << BITP_SPORT_CTL_A_DTYPE) |                         \
	 (ADI_SPORT3A_CTL_LSBF << BITP_SPORT_CTL_A_LSBF) |                           \
	 (ADI_SPORT3A_CTL_SLEN << BITP_SPORT_CTL_A_SLEN) |                           \
	 (ADI_SPORT3A_CTL_PACK << BITP_SPORT_CTL_A_PACK) |                           \
	 (ADI_SPORT3A_CTL_ICLK << BITP_SPORT_CTL_A_ICLK) |                           \
	 (ADI_SPORT3A_CTL_OPMODE << BITP_SPORT_CTL_A_OPMODE) |                       \
	 (ADI_SPORT3A_CTL_CKRE                                                       \
	  << BITP_SPORT_CTL_A_CKRE) /*|(ADI_SPORT3A_CTL_FSR<<BITP_SPORT_CTL_A_FSR)*/ \
	 | (ADI_SPORT3A_CTL_IFS << BITP_SPORT_CTL_A_IFS) |                           \
	 (ADI_SPORT3A_CTL_DIFS << BITP_SPORT_CTL_A_DIFS) |                           \
	 (ADI_SPORT3A_CTL_LFS << BITP_SPORT_CTL_A_LFS) |                             \
	 (ADI_SPORT3A_CTL_LAFS << BITP_SPORT_CTL_A_LAFS) |                           \
	 (ADI_SPORT3A_CTL_RJUST << BITP_SPORT_CTL_A_RJUST) |                         \
	 (ADI_SPORT3A_CTL_FSED << BITP_SPORT_CTL_A_FSED) |                           \
	 (ADI_SPORT3A_CTL_GCLKEN << BITP_SPORT_CTL_A_GCLKEN) |                       \
	 (ADI_SPORT3A_CTL_SPTRAN << BITP_SPORT_CTL_A_SPTRAN))
...
#define ADI_SPORT_3A_DIV                                       \
	((ADI_SPORT3A_DIV_CLKDIV << BITP_SPORT_DIV_A_CLKDIV) | \
	 (ADI_SPORT3A_DIV_FSDIV << BITP_SPORT_DIV_A_FSDIV))
...
#define ADI_SPORT_3A_MCTL                                      \
	((ADI_SPORT3A_MCTL_MCE << BITP_SPORT_MCTL_A_MCE) |     \
	 (ADI_SPORT3A_MCTL_MCPDE << BITP_SPORT_MCTL_A_MCPDE) | \
	 (ADI_SPORT3A_MCTL_MFD << BITP_SPORT_MCTL_A_MFD) |     \
	 (ADI_SPORT3A_MCTL_WSIZE << BITP_SPORT_MCTL_A_WSIZE) | \
	 (ADI_SPORT3A_MCTL_WOFFSET << BITP_SPORT_MCTL_A_WOFFSET))
...
#define ADI_SPORT_3B_CTL                                                             \
	((ADI_SPORT3B_CTL_DTYPE << BITP_SPORT_CTL_B_DTYPE) |                         \
	 (ADI_SPORT3B_CTL_LSBF << BITP_SPORT_CTL_B_LSBF) |                           \
	 (ADI_SPORT3B_CTL_SLEN << BITP_SPORT_CTL_B_SLEN) |                           \
	 (ADI_SPORT3B_CTL_PACK << BITP_SPORT_CTL_B_PACK) |                           \
	 (ADI_SPORT3B_CTL_ICLK << BITP_SPORT_CTL_B_ICLK) |                           \
	 (ADI_SPORT3B_CTL_OPMODE << BITP_SPORT_CTL_B_OPMODE) |                       \
	 (ADI_SPORT3B_CTL_CKRE                                                       \
	  << BITP_SPORT_CTL_B_CKRE) /*|(ADI_SPORT3B_CTL_FSR<<BITP_SPORT_CTL_B_FSR)*/ \
	 | (ADI_SPORT3B_CTL_IFS << BITP_SPORT_CTL_B_IFS) |                           \
	 (ADI_SPORT3B_CTL_DIFS << BITP_SPORT_CTL_B_DIFS) |                           \
	 (ADI_SPORT3B_CTL_LFS << BITP_SPORT_CTL_B_LFS) |                             \
	 (ADI_SPORT3B_CTL_LAFS << BITP_SPORT_CTL_B_LAFS) |                           \
	 (ADI_SPORT3B_CTL_RJUST << BITP_SPORT_CTL_B_RJUST) |                         \
	 (ADI_SPORT3B_CTL_FSED << BITP_SPORT_CTL_B_FSED) |                           \
	 (ADI_SPORT3B_CTL_GCLKEN << BITP_SPORT_CTL_B_GCLKEN) |                       \
	 (ADI_SPORT3B_CTL_SPTRAN << BITP_SPORT_CTL_B_SPTRAN))
...
#define ADI_SPORT_3B_DIV                                       \
	((ADI_SPORT3B_DIV_CLKDIV << BITP_SPORT_DIV_B_CLKDIV) | \
	 (ADI_SPORT3B_DIV_FSDIV << BITP_SPORT_DIV_B_FSDIV))
...
#define ADI_SPORT_3B_MCTL                                      \
	((ADI_SPORT3B_MCTL_MCE << BITP_SPORT_MCTL_B_MCE) |     \
	 (ADI_SPORT3B_MCTL_MCPDE << BITP_SPORT_MCTL_B_MCPDE) | \
	 (ADI_SPORT3B_MCTL_MFD << BITP_SPORT_MCTL_B_MFD) |     \
	 (ADI_SPORT3B_MCTL_WSIZE << BITP_SPORT_MCTL_B_WSIZE) | \
	 (ADI_SPORT3B_MCTL_WOFFSET << BITP_SPORT_MCTL_B_WOFFSET))
...
#define ADI_SPORT_4A_CTL                                                             \
	((ADI_SPORT4A_CTL_DTYPE << BITP_SPORT_CTL_A_DTYPE) |                         \
	 (ADI_SPORT4A_CTL_LSBF << BITP_SPORT_CTL_A_LSBF) |                           \
	 (ADI_SPORT4A_CTL_SLEN << BITP_SPORT_CTL_A_SLEN) |                           \
	 (ADI_SPORT4A_CTL_PACK << BITP_SPORT_CTL_A_PACK) |                           \
	 (ADI_SPORT4A_CTL_ICLK << BITP_SPORT_CTL_A_ICLK) |                           \
	 (ADI_SPORT4A_CTL_OPMODE << BITP_SPORT_CTL_A_OPMODE) |                       \
	 (ADI_SPORT4A_CTL_CKRE                                                       \
	  << BITP_SPORT_CTL_A_CKRE) /*|(ADI_SPORT4A_CTL_FSR<<BITP_SPORT_CTL_A_FSR)*/ \
	 | (ADI_SPORT4A_CTL_IFS << BITP_SPORT_CTL_A_IFS) |                           \
	 (ADI_SPORT4A_CTL_DIFS << BITP_SPORT_CTL_A_DIFS) |                           \
	 (ADI_SPORT4A_CTL_LFS << BITP_SPORT_CTL_A_LFS) |                             \
	 (ADI_SPORT4A_CTL_LAFS << BITP_SPORT_CTL_A_LAFS) |                           \
	 (ADI_SPORT4A_CTL_RJUST << BITP_SPORT_CTL_A_RJUST) |                         \
	 (ADI_SPORT4A_CTL_FSED << BITP_SPORT_CTL_A_FSED) |                           \
	 (ADI_SPORT4A_CTL_GCLKEN << BITP_SPORT_CTL_A_GCLKEN) |                       \
	 (ADI_SPORT4A_CTL_SPTRAN << BITP_SPORT_CTL_A_SPTRAN))
...
#define ADI_SPORT_4A_DIV                                       \
	((ADI_SPORT4A_DIV_CLKDIV << BITP_SPORT_DIV_A_CLKDIV) | \
	 (ADI_SPORT4A_DIV_FSDIV << BITP_SPORT_DIV_A_FSDIV))
...
#define ADI_SPORT_4A_MCTL                                      \
	((ADI_SPORT4A_MCTL_MCE << BITP_SPORT_MCTL_A_MCE) |     \
	 (ADI_SPORT4A_MCTL_MCPDE << BITP_SPORT_MCTL_A_MCPDE) | \
	 (ADI_SPORT4A_MCTL_MFD << BITP_SPORT_MCTL_A_MFD) |     \
	 (ADI_SPORT4A_MCTL_WSIZE << BITP_SPORT_MCTL_A_WSIZE) | \
	 (ADI_SPORT4A_MCTL_WOFFSET << BITP_SPORT_MCTL_A_WOFFSET))
...
#define ADI_SPORT_4B_CTL                                                             \
	((ADI_SPORT4B_CTL_DTYPE << BITP_SPORT_CTL_B_DTYPE) |                         \
	 (ADI_SPORT4B_CTL_LSBF << BITP_SPORT_CTL_B_LSBF) |                           \
	 (ADI_SPORT4B_CTL_SLEN << BITP_SPORT_CTL_B_SLEN) |                           \
	 (ADI_SPORT4B_CTL_PACK << BITP_SPORT_CTL_B_PACK) |                           \
	 (ADI_SPORT4B_CTL_ICLK << BITP_SPORT_CTL_B_ICLK) |                           \
	 (ADI_SPORT4B_CTL_OPMODE << BITP_SPORT_CTL_B_OPMODE) |                       \
	 (ADI_SPORT4B_CTL_CKRE                                                       \
	  << BITP_SPORT_CTL_B_CKRE) /*|(ADI_SPORT4B_CTL_FSR<<BITP_SPORT_CTL_B_FSR)*/ \
	 | (ADI_SPORT4B_CTL_IFS << BITP_SPORT_CTL_B_IFS) |                           \
	 (ADI_SPORT4B_CTL_DIFS << BITP_SPORT_CTL_B_DIFS) |                           \
	 (ADI_SPORT4B_CTL_LFS << BITP_SPORT_CTL_B_LFS) |                             \
	 (ADI_SPORT4B_CTL_LAFS << BITP_SPORT_CTL_B_LAFS) |                           \
	 (ADI_SPORT4B_CTL_RJUST << BITP_SPORT_CTL_B_RJUST) |                         \
	 (ADI_SPORT4B_CTL_FSED << BITP_SPORT_CTL_B_FSED) |                           \
	 (ADI_SPORT4B_CTL_GCLKEN << BITP_SPORT_CTL_B_GCLKEN) |                       \
	 (ADI_SPORT4B_CTL_SPTRAN << BITP_SPORT_CTL_B_SPTRAN))
...
#define ADI_SPORT_4B_DIV                                       \
	((ADI_SPORT4B_DIV_CLKDIV << BITP_SPORT_DIV_B_CLKDIV) | \
	 (ADI_SPORT4B_DIV_FSDIV << BITP_SPORT_DIV_B_FSDIV))
...
#define ADI_SPORT_4B_MCTL                                      \
	((ADI_SPORT4B_MCTL_MCE << BITP_SPORT_MCTL_B_MCE) |     \
	 (ADI_SPORT4B_MCTL_MCPDE << BITP_SPORT_MCTL_B_MCPDE) | \
	 (ADI_SPORT4B_MCTL_MFD << BITP_SPORT_MCTL_B_MFD) |     \
	 (ADI_SPORT4B_MCTL_WSIZE << BITP_SPORT_MCTL_B_WSIZE) | \
	 (ADI_SPORT4B_MCTL_WOFFSET << BITP_SPORT_MCTL_B_WOFFSET))
...
#define ADI_SPORT_5A_CTL                                                             \
	((ADI_SPORT5A_CTL_DTYPE << BITP_SPORT_CTL_A_DTYPE) |                         \
	 (ADI_SPORT5A_CTL_LSBF << BITP_SPORT_CTL_A_LSBF) |                           \
	 (ADI_SPORT5A_CTL_SLEN << BITP_SPORT_CTL_A_SLEN) |                           \
	 (ADI_SPORT5A_CTL_PACK << BITP_SPORT_CTL_A_PACK) |                           \
	 (ADI_SPORT5A_CTL_ICLK << BITP_SPORT_CTL_A_ICLK) |                           \
	 (ADI_SPORT5A_CTL_OPMODE << BITP_SPORT_CTL_A_OPMODE) |                       \
	 (ADI_SPORT5A_CTL_CKRE                                                       \
	  << BITP_SPORT_CTL_A_CKRE) /*|(ADI_SPORT5A_CTL_FSR<<BITP_SPORT_CTL_A_FSR)*/ \
	 | (ADI_SPORT5A_CTL_IFS << BITP_SPORT_CTL_A_IFS) |                           \
	 (ADI_SPORT5A_CTL_DIFS << BITP_SPORT_CTL_A_DIFS) |                           \
	 (ADI_SPORT5A_CTL_LFS << BITP_SPORT_CTL_A_LFS) |                             \
	 (ADI_SPORT5A_CTL_LAFS << BITP_SPORT_CTL_A_LAFS) |                           \
	 (ADI_SPORT5A_CTL_RJUST << BITP_SPORT_CTL_A_RJUST) |                         \
	 (ADI_SPORT5A_CTL_FSED << BITP_SPORT_CTL_A_FSED) |                           \
	 (ADI_SPORT5A_CTL_GCLKEN << BITP_SPORT_CTL_A_GCLKEN) |                       \
	 (ADI_SPORT5A_CTL_SPTRAN << BITP_SPORT_CTL_A_SPTRAN))
...
#define ADI_SPORT_5A_DIV                                       \
	((ADI_SPORT5A_DIV_CLKDIV << BITP_SPORT_DIV_A_CLKDIV) | \
	 (ADI_SPORT5A_DIV_FSDIV << BITP_SPORT_DIV_A_FSDIV))
...
/*! Specifies the SPORT0A_Multichannel Control register Configuration*/
#define ADI_SPORT_5A_MCTL                                      \
	((ADI_SPORT5A_MCTL_MCE << BITP_SPORT_MCTL_A_MCE) |     \
	 (ADI_SPORT5A_MCTL_MCPDE << BITP_SPORT_MCTL_A_MCPDE) | \
	 (ADI_SPORT5A_MCTL_MFD << BITP_SPORT_MCTL_A_MFD) |     \
	 (ADI_SPORT5A_MCTL_WSIZE << BITP_SPORT_MCTL_A_WSIZE) | \
	 (ADI_SPORT5A_MCTL_WOFFSET << BITP_SPORT_MCTL_A_WOFFSET))
...
#define ADI_SPORT_5B_CTL                                                             \
	((ADI_SPORT5B_CTL_DTYPE << BITP_SPORT_CTL_B_DTYPE) |                         \
	 (ADI_SPORT5B_CTL_LSBF << BITP_SPORT_CTL_B_LSBF) |                           \
	 (ADI_SPORT5B_CTL_SLEN << BITP_SPORT_CTL_B_SLEN) |                           \
	 (ADI_SPORT5B_CTL_PACK << BITP_SPORT_CTL_B_PACK) |                           \
	 (ADI_SPORT5B_CTL_ICLK << BITP_SPORT_CTL_B_ICLK) |                           \
	 (ADI_SPORT5B_CTL_OPMODE << BITP_SPORT_CTL_B_OPMODE) |                       \
	 (ADI_SPORT5B_CTL_CKRE                                                       \
	  << BITP_SPORT_CTL_B_CKRE) /*|(ADI_SPORT5B_CTL_FSR<<BITP_SPORT_CTL_B_FSR)*/ \
	 | (ADI_SPORT5B_CTL_IFS << BITP_SPORT_CTL_B_IFS) |                           \
	 (ADI_SPORT5B_CTL_DIFS << BITP_SPORT_CTL_B_DIFS) |                           \
	 (ADI_SPORT5B_CTL_LFS << BITP_SPORT_CTL_B_LFS) |                             \
	 (ADI_SPORT5B_CTL_LAFS << BITP_SPORT_CTL_B_LAFS) |                           \
	 (ADI_SPORT5B_CTL_RJUST << BITP_SPORT_CTL_B_RJUST) |                         \
	 (ADI_SPORT5B_CTL_FSED << BITP_SPORT_CTL_B_FSED) |                           \
	 (ADI_SPORT5B_CTL_GCLKEN << BITP_SPORT_CTL_B_GCLKEN) |                       \
	 (ADI_SPORT5B_CTL_SPTRAN << BITP_SPORT_CTL_B_SPTRAN))
...
#define ADI_SPORT_5B_DIV                                       \
	((ADI_SPORT5B_DIV_CLKDIV << BITP_SPORT_DIV_B_CLKDIV) | \
	 (ADI_SPORT5B_DIV_FSDIV << BITP_SPORT_DIV_B_FSDIV))
...
#define ADI_SPORT_5B_MCTL                                      \
	((ADI_SPORT5B_MCTL_MCE << BITP_SPORT_MCTL_B_MCE) |     \
	 (ADI_SPORT5B_MCTL_MCPDE << BITP_SPORT_MCTL_B_MCPDE) | \
	 (ADI_SPORT5B_MCTL_MFD << BITP_SPORT_MCTL_B_MFD) |     \
	 (ADI_SPORT5B_MCTL_WSIZE << BITP_SPORT_MCTL_B_WSIZE) | \
	 (ADI_SPORT5B_MCTL_WOFFSET << BITP_SPORT_MCTL_B_WOFFSET))
...
#define ADI_SPORT_6A_CTL                                                             \
	((ADI_SPORT6A_CTL_DTYPE << BITP_SPORT_CTL_A_DTYPE) |                         \
	 (ADI_SPORT6A_CTL_LSBF << BITP_SPORT_CTL_A_LSBF) |                           \
	 (ADI_SPORT6A_CTL_SLEN << BITP_SPORT_CTL_A_SLEN) |                           \
	 (ADI_SPORT6A_CTL_PACK << BITP_SPORT_CTL_A_PACK) |                           \
	 (ADI_SPORT6A_CTL_ICLK << BITP_SPORT_CTL_A_ICLK) |                           \
	 (ADI_SPORT6A_CTL_OPMODE << BITP_SPORT_CTL_A_OPMODE) |                       \
	 (ADI_SPORT6A_CTL_CKRE                                                       \
	  << BITP_SPORT_CTL_A_CKRE) /*|(ADI_SPORT6A_CTL_FSR<<BITP_SPORT_CTL_A_FSR)*/ \
	 | (ADI_SPORT6A_CTL_IFS << BITP_SPORT_CTL_A_IFS) |                           \
	 (ADI_SPORT6A_CTL_DIFS << BITP_SPORT_CTL_A_DIFS) |                           \
	 (ADI_SPORT6A_CTL_LFS << BITP_SPORT_CTL_A_LFS) |                             \
	 (ADI_SPORT6A_CTL_LAFS << BITP_SPORT_CTL_A_LAFS) |                           \
	 (ADI_SPORT6A_CTL_RJUST << BITP_SPORT_CTL_A_RJUST) |                         \
	 (ADI_SPORT6A_CTL_FSED << BITP_SPORT_CTL_A_FSED) |                           \
	 (ADI_SPORT6A_CTL_GCLKEN << BITP_SPORT_CTL_A_GCLKEN) |                       \
	 (ADI_SPORT6A_CTL_SPTRAN << BITP_SPORT_CTL_A_SPTRAN))
...
#define ADI_SPORT_6A_DIV                                       \
	((ADI_SPORT6A_DIV_CLKDIV << BITP_SPORT_DIV_A_CLKDIV) | \
	 (ADI_SPORT6A_DIV_FSDIV << BITP_SPORT_DIV_A_FSDIV))
...
#define ADI_SPORT_6A_MCTL                                      \
	((ADI_SPORT6A_MCTL_MCE << BITP_SPORT_MCTL_A_MCE) |     \
	 (ADI_SPORT6A_MCTL_MCPDE << BITP_SPORT_MCTL_A_MCPDE) | \
	 (ADI_SPORT6A_MCTL_MFD << BITP_SPORT_MCTL_A_MFD) |     \
	 (ADI_SPORT6A_MCTL_WSIZE << BITP_SPORT_MCTL_A_WSIZE) | \
	 (ADI_SPORT6A_MCTL_WOFFSET << BITP_SPORT_MCTL_A_WOFFSET))
...
#define ADI_SPORT_6B_CTL                                                             \
	((ADI_SPORT6B_CTL_DTYPE << BITP_SPORT_CTL_B_DTYPE) |                         \
	 (ADI_SPORT6B_CTL_LSBF << BITP_SPORT_CTL_B_LSBF) |                           \
	 (ADI_SPORT6B_CTL_SLEN << BITP_SPORT_CTL_B_SLEN) |                           \
	 (ADI_SPORT6B_CTL_PACK << BITP_SPORT_CTL_B_PACK) |                           \
	 (ADI_SPORT6B_CTL_ICLK << BITP_SPORT_CTL_B_ICLK) |                           \
	 (ADI_SPORT6B_CTL_OPMODE << BITP_SPORT_CTL_B_OPMODE) |                       \
	 (ADI_SPORT6B_CTL_CKRE                                                       \
	  << BITP_SPORT_CTL_B_CKRE) /*|(ADI_SPORT6B_CTL_FSR<<BITP_SPORT_CTL_B_FSR)*/ \
	 | (ADI_SPORT6B_CTL_IFS << BITP_SPORT_CTL_B_IFS) |                           \
	 (ADI_SPORT6B_CTL_DIFS << BITP_SPORT_CTL_B_DIFS) |                           \
	 (ADI_SPORT6B_CTL_LFS << BITP_SPORT_CTL_B_LFS) |                             \
	 (ADI_SPORT6B_CTL_LAFS << BITP_SPORT_CTL_B_LAFS) |                           \
	 (ADI_SPORT6B_CTL_RJUST << BITP_SPORT_CTL_B_RJUST) |                         \
	 (ADI_SPORT6B_CTL_FSED << BITP_SPORT_CTL_B_FSED) |                           \
	 (ADI_SPORT6B_CTL_GCLKEN << BITP_SPORT_CTL_B_GCLKEN) |                       \
	 (ADI_SPORT6B_CTL_SPTRAN << BITP_SPORT_CTL_B_SPTRAN))
...
#define ADI_SPORT_6B_DIV                                       \
	((ADI_SPORT6B_DIV_CLKDIV << BITP_SPORT_DIV_B_CLKDIV) | \
	 (ADI_SPORT6B_DIV_FSDIV << BITP_SPORT_DIV_B_FSDIV))
...
#define ADI_SPORT_6B_MCTL                                      \
	((ADI_SPORT6B_MCTL_MCE << BITP_SPORT_MCTL_B_MCE) |     \
	 (ADI_SPORT6B_MCTL_MCPDE << BITP_SPORT_MCTL_B_MCPDE) | \
	 (ADI_SPORT6B_MCTL_MFD << BITP_SPORT_MCTL_B_MFD) |     \
	 (ADI_SPORT6B_MCTL_WSIZE << BITP_SPORT_MCTL_B_WSIZE) | \
	 (ADI_SPORT6B_MCTL_WOFFSET << BITP_SPORT_MCTL_B_WOFFSET))
...
#define ADI_SPORT_7A_CTL                                                             \
	((ADI_SPORT7A_CTL_DTYPE << BITP_SPORT_CTL_A_DTYPE) |                         \
	 (ADI_SPORT7A_CTL_LSBF << BITP_SPORT_CTL_A_LSBF) |                           \
	 (ADI_SPORT7A_CTL_SLEN << BITP_SPORT_CTL_A_SLEN) |                           \
	 (ADI_SPORT7A_CTL_PACK << BITP_SPORT_CTL_A_PACK) |                           \
	 (ADI_SPORT7A_CTL_ICLK << BITP_SPORT_CTL_A_ICLK) |                           \
	 (ADI_SPORT7A_CTL_OPMODE << BITP_SPORT_CTL_A_OPMODE) |                       \
	 (ADI_SPORT7A_CTL_CKRE                                                       \
	  << BITP_SPORT_CTL_A_CKRE) /*|(ADI_SPORT7A_CTL_FSR<<BITP_SPORT_CTL_A_FSR)*/ \
	 | (ADI_SPORT7A_CTL_IFS << BITP_SPORT_CTL_A_IFS) |                           \
	 (ADI_SPORT7A_CTL_DIFS << BITP_SPORT_CTL_A_DIFS) |                           \
	 (ADI_SPORT7A_CTL_LFS << BITP_SPORT_CTL_A_LFS) |                             \
	 (ADI_SPORT7A_CTL_LAFS << BITP_SPORT_CTL_A_LAFS) |                           \
	 (ADI_SPORT7A_CTL_RJUST << BITP_SPORT_CTL_A_RJUST) |                         \
	 (ADI_SPORT7A_CTL_FSED << BITP_SPORT_CTL_A_FSED) |                           \
	 (ADI_SPORT7A_CTL_GCLKEN << BITP_SPORT_CTL_A_GCLKEN) |                       \
...
#define ADI_SPORT_7A_DIV                                       \
	((ADI_SPORT7A_DIV_CLKDIV << BITP_SPORT_DIV_A_CLKDIV) | \
	 (ADI_SPORT7A_DIV_FSDIV << BITP_SPORT_DIV_A_FSDIV))
...
#define ADI_SPORT_7A_MCTL                                      \
	((ADI_SPORT7A_MCTL_MCE << BITP_SPORT_MCTL_A_MCE) |     \
	 (ADI_SPORT7A_MCTL_MCPDE << BITP_SPORT_MCTL_A_MCPDE) | \
	 (ADI_SPORT7A_MCTL_MFD << BITP_SPORT_MCTL_A_MFD) |     \
	 (ADI_SPORT7A_MCTL_WSIZE << BITP_SPORT_MCTL_A_WSIZE) | \
	 (ADI_SPORT7A_MCTL_WOFFSET << BITP_SPORT_MCTL_A_WOFFSET))
...
#define ADI_SPORT_7B_CTL                                                             \
	((ADI_SPORT7B_CTL_DTYPE << BITP_SPORT_CTL_B_DTYPE) |                         \
	 (ADI_SPORT7B_CTL_LSBF << BITP_SPORT_CTL_B_LSBF) |                           \
	 (ADI_SPORT7B_CTL_SLEN << BITP_SPORT_CTL_B_SLEN) |                           \
	 (ADI_SPORT7B_CTL_PACK << BITP_SPORT_CTL_B_PACK) |                           \
	 (ADI_SPORT7B_CTL_ICLK << BITP_SPORT_CTL_B_ICLK) |                           \
	 (ADI_SPORT7B_CTL_OPMODE << BITP_SPORT_CTL_B_OPMODE) |                       \
	 (ADI_SPORT7B_CTL_CKRE                                                       \
	  << BITP_SPORT_CTL_B_CKRE) /*|(ADI_SPORT7B_CTL_FSR<<BITP_SPORT_CTL_B_FSR)*/ \
	 | (ADI_SPORT7B_CTL_IFS << BITP_SPORT_CTL_B_IFS) |                           \
	 (ADI_SPORT7B_CTL_DIFS << BITP_SPORT_CTL_B_DIFS) |                           \
	 (ADI_SPORT7B_CTL_LFS << BITP_SPORT_CTL_B_LFS) |                             \
	 (ADI_SPORT7B_CTL_LAFS << BITP_SPORT_CTL_B_LAFS) |                           \
	 (ADI_SPORT7B_CTL_RJUST << BITP_SPORT_CTL_B_RJUST) |                         \
	 (ADI_SPORT7B_CTL_FSED << BITP_SPORT_CTL_B_FSED) |                           \
	 (ADI_SPORT7B_CTL_GCLKEN << BITP_SPORT_CTL_B_GCLKEN) |                       \
	 (ADI_SPORT7B_CTL_SPTRAN << BITP_SPORT_CTL_B_SPTRAN))
...
#define ADI_SPORT_7B_DIV                                       \
	((ADI_SPORT7B_DIV_CLKDIV << BITP_SPORT_DIV_B_CLKDIV) | \
	 (ADI_SPORT7B_DIV_FSDIV << BITP_SPORT_DIV_B_FSDIV))
...
#define ADI_SPORT_7B_MCTL                                      \
	((ADI_SPORT7B_MCTL_MCE << BITP_SPORT_MCTL_B_MCE) |     \
	 (ADI_SPORT7B_MCTL_MCPDE << BITP_SPORT_MCTL_B_MCPDE) | \
	 (ADI_SPORT7B_MCTL_MFD << BITP_SPORT_MCTL_B_MFD) |     \
	 (ADI_SPORT7B_MCTL_WSIZE << BITP_SPORT_MCTL_B_WSIZE) | \
	 (ADI_SPORT7B_MCTL_WOFFSET << BITP_SPORT_MCTL_B_WOFFSET))
...
#endif /*__ADI_SPORT_CONFIG_SC59X_H__*/
