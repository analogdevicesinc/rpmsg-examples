...
volatile uint32_t *SPORT_CTL[SPORT_END] = {
	pREG_SPORT0_CTL_A, pREG_SPORT0_CTL_B, pREG_SPORT1_CTL_A,
	pREG_SPORT1_CTL_B, pREG_SPORT2_CTL_A, pREG_SPORT2_CTL_B,
	...
	pREG_SPORT4_CTL_A, pREG_SPORT4_CTL_B, pREG_SPORT5_CTL_A,
	pREG_SPORT5_CTL_B, pREG_SPORT6_CTL_A, pREG_SPORT6_CTL_B,
	pREG_SPORT7_CTL_A, pREG_SPORT7_CTL_B
#endif
};

volatile uint32_t *SPORT_MCTL[SPORT_END] = {
	pREG_SPORT0_MCTL_A, pREG_SPORT0_MCTL_B, pREG_SPORT1_MCTL_A,
	pREG_SPORT1_MCTL_B, pREG_SPORT2_MCTL_A, pREG_SPORT2_MCTL_B,
	pREG_SPORT3_MCTL_A, pREG_SPORT3_MCTL_B,
#if defined(__ADSPSC589_FAMILY__) || defined(__ADSP21569_FAMILY__) || \
	defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)
	pREG_SPORT4_MCTL_A, pREG_SPORT4_MCTL_B, pREG_SPORT5_MCTL_A,
	pREG_SPORT5_MCTL_B, pREG_SPORT6_MCTL_A, pREG_SPORT6_MCTL_B,
	pREG_SPORT7_MCTL_A, pREG_SPORT7_MCTL_B
#endif
};

volatile uint32_t *SPORT_CS0[SPORT_END] = {
	pREG_SPORT0_CS0_A, pREG_SPORT0_CS0_B, pREG_SPORT1_CS0_A,
	pREG_SPORT1_CS0_B, pREG_SPORT2_CS0_A, pREG_SPORT2_CS0_B,
	pREG_SPORT3_CS0_A, pREG_SPORT3_CS0_B,
#if defined(__ADSPSC589_FAMILY__) || defined(__ADSP21569_FAMILY__) || \
	defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)
	pREG_SPORT4_CS0_A, pREG_SPORT4_CS0_B, pREG_SPORT5_CS0_A,
	pREG_SPORT5_CS0_B, pREG_SPORT6_CS0_A, pREG_SPORT6_CS0_B,
	pREG_SPORT7_CS0_A, pREG_SPORT7_CS0_B
#endif
};

volatile uint32_t *SPORT_DIV[SPORT_END] = {
	pREG_SPORT0_DIV_A, pREG_SPORT0_DIV_B, pREG_SPORT1_DIV_A,
	pREG_SPORT1_DIV_B, pREG_SPORT2_DIV_A, pREG_SPORT2_DIV_B,
	pREG_SPORT3_DIV_A, pREG_SPORT3_DIV_B,
#if defined(__ADSPSC589_FAMILY__) || defined(__ADSP21569_FAMILY__) || \
	defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)
	pREG_SPORT4_DIV_A, pREG_SPORT4_DIV_B, pREG_SPORT5_DIV_A,
	pREG_SPORT5_DIV_B, pREG_SPORT6_DIV_A, pREG_SPORT6_DIV_B,
	pREG_SPORT7_DIV_A, pREG_SPORT7_DIV_B
#endif
};

_Addr_t __IO *DMA_ADDRSTART[SPORT_END] = {
	pREG_DMA0_ADDRSTART,  pREG_DMA1_ADDRSTART,  pREG_DMA2_ADDRSTART,
	pREG_DMA3_ADDRSTART,  pREG_DMA4_ADDRSTART,  pREG_DMA5_ADDRSTART,
	pREG_DMA6_ADDRSTART,  pREG_DMA7_ADDRSTART,
#if defined(__ADSPSC589_FAMILY__) || defined(__ADSP21569_FAMILY__) || \
	defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)
	pREG_DMA10_ADDRSTART, pREG_DMA11_ADDRSTART, pREG_DMA12_ADDRSTART,
	pREG_DMA13_ADDRSTART, pREG_DMA14_ADDRSTART, pREG_DMA15_ADDRSTART,
	pREG_DMA16_ADDRSTART, pREG_DMA17_ADDRSTART
#endif
};

_Addr_t __IO *DMA_DSCPTR_NXT[SPORT_END] = {
	pREG_DMA0_DSCPTR_NXT,  pREG_DMA1_DSCPTR_NXT,  pREG_DMA2_DSCPTR_NXT,
	pREG_DMA3_DSCPTR_NXT,  pREG_DMA4_DSCPTR_NXT,  pREG_DMA5_DSCPTR_NXT,
	pREG_DMA6_DSCPTR_NXT,  pREG_DMA7_DSCPTR_NXT,
#if defined(__ADSPSC589_FAMILY__) || defined(__ADSP21569_FAMILY__) || \
	defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)
	pREG_DMA10_DSCPTR_NXT, pREG_DMA11_DSCPTR_NXT, pREG_DMA12_DSCPTR_NXT,
	pREG_DMA13_DSCPTR_NXT, pREG_DMA14_DSCPTR_NXT, pREG_DMA15_DSCPTR_NXT,
	pREG_DMA16_DSCPTR_NXT, pREG_DMA17_DSCPTR_NXT
#endif
};

volatile uint32_t *DMA_XCNT[SPORT_END] = {
	pREG_DMA0_XCNT,	 pREG_DMA1_XCNT,  pREG_DMA2_XCNT,  pREG_DMA3_XCNT,
	pREG_DMA4_XCNT,	 pREG_DMA5_XCNT,  pREG_DMA6_XCNT,  pREG_DMA7_XCNT,
#if defined(__ADSPSC589_FAMILY__) || defined(__ADSP21569_FAMILY__) || \
	defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)
	pREG_DMA10_XCNT, pREG_DMA11_XCNT, pREG_DMA12_XCNT, pREG_DMA13_XCNT,
	pREG_DMA14_XCNT, pREG_DMA15_XCNT, pREG_DMA16_XCNT, pREG_DMA17_XCNT
#endif
};

volatile int32_t *DMA_XMOD[SPORT_END] = {
	pREG_DMA0_XMOD,	 pREG_DMA1_XMOD,  pREG_DMA2_XMOD,  pREG_DMA3_XMOD,
	pREG_DMA4_XMOD,	 pREG_DMA5_XMOD,  pREG_DMA6_XMOD,  pREG_DMA7_XMOD,
#if defined(__ADSPSC589_FAMILY__) || defined(__ADSP21569_FAMILY__) || \
	defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)
	pREG_DMA10_XMOD, pREG_DMA11_XMOD, pREG_DMA12_XMOD, pREG_DMA13_XMOD,
	pREG_DMA14_XMOD, pREG_DMA15_XMOD, pREG_DMA16_XMOD, pREG_DMA17_XMOD
#endif
};

volatile uint32_t *DMA_CFG[SPORT_END] = {
	pREG_DMA0_CFG,	pREG_DMA1_CFG,	pREG_DMA2_CFG,	pREG_DMA3_CFG,
	pREG_DMA4_CFG,	pREG_DMA5_CFG,	pREG_DMA6_CFG,	pREG_DMA7_CFG,
#if defined(__ADSPSC589_FAMILY__) || defined(__ADSP21569_FAMILY__) || \
	defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)
	pREG_DMA10_CFG, pREG_DMA11_CFG, pREG_DMA12_CFG, pREG_DMA13_CFG,
	pREG_DMA14_CFG, pREG_DMA15_CFG, pREG_DMA16_CFG, pREG_DMA17_CFG
#endif
};

volatile uint32_t *DMA_STAT[SPORT_END] = {
	pREG_DMA0_STAT,	 pREG_DMA1_STAT,  pREG_DMA2_STAT,  pREG_DMA3_STAT,
	pREG_DMA4_STAT,	 pREG_DMA5_STAT,  pREG_DMA6_STAT,  pREG_DMA7_STAT,
#if defined(__ADSPSC589_FAMILY__) || defined(__ADSP21569_FAMILY__) || \
	defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)
	pREG_DMA10_STAT, pREG_DMA11_STAT, pREG_DMA12_STAT, pREG_DMA13_STAT,
	pREG_DMA14_STAT, pREG_DMA15_STAT, pREG_DMA16_STAT, pREG_DMA17_STAT
#endif
};

volatile uint32_t *SPU_SECUREP[SPORT_END] = {
#if defined(__ADSP21569_FAMILY__)
	pREG_SPU0_SECUREP49, pREG_SPU0_SECUREP50, pREG_SPU0_SECUREP51,
	pREG_SPU0_SECUREP52, pREG_SPU0_SECUREP53, pREG_SPU0_SECUREP54,
	pREG_SPU0_SECUREP55, pREG_SPU0_SECUREP56, pREG_SPU0_SECUREP57,
	pREG_SPU0_SECUREP58, pREG_SPU0_SECUREP59, pREG_SPU0_SECUREP60,
	pREG_SPU0_SECUREP61, pREG_SPU0_SECUREP62, pREG_SPU0_SECUREP63,
	pREG_SPU0_SECUREP64,
#elif defined(__ADSPSC573_FAMILY__)
	pREG_SPU0_SECUREP48, pREG_SPU0_SECUREP49, pREG_SPU0_SECUREP50,
	pREG_SPU0_SECUREP51, pREG_SPU0_SECUREP52, pREG_SPU0_SECUREP53,
	pREG_SPU0_SECUREP54, pREG_SPU0_SECUREP55
#elif defined(__ADSPSC589_FAMILY__)
	pREG_SPU0_SECUREP66, pREG_SPU0_SECUREP67, pREG_SPU0_SECUREP68,
	pREG_SPU0_SECUREP69, pREG_SPU0_SECUREP70, pREG_SPU0_SECUREP71,
	pREG_SPU0_SECUREP72, pREG_SPU0_SECUREP73, pREG_SPU0_SECUREP74,
	pREG_SPU0_SECUREP75, pREG_SPU0_SECUREP76, pREG_SPU0_SECUREP77,
	pREG_SPU0_SECUREP78, pREG_SPU0_SECUREP79, pREG_SPU0_SECUREP80,
	pREG_SPU0_SECUREP81,
#elif defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)
	pREG_SPU0_SECUREP63, pREG_SPU0_SECUREP64, pREG_SPU0_SECUREP65,
	pREG_SPU0_SECUREP66, pREG_SPU0_SECUREP67, pREG_SPU0_SECUREP68,
	pREG_SPU0_SECUREP69, pREG_SPU0_SECUREP70, pREG_SPU0_SECUREP71,
	pREG_SPU0_SECUREP72, pREG_SPU0_SECUREP73, pREG_SPU0_SECUREP74,
	pREG_SPU0_SECUREP75, pREG_SPU0_SECUREP76, pREG_SPU0_SECUREP77,
...
uint16_t SPORT_DMA_IRQ_ID[SPORT_END] = {
	INTR_SPORT0_A_DMA, INTR_SPORT0_B_DMA, INTR_SPORT1_A_DMA,
	INTR_SPORT1_B_DMA, INTR_SPORT2_A_DMA, INTR_SPORT2_B_DMA,
	INTR_SPORT3_A_DMA, INTR_SPORT3_B_DMA,
#if defined(__ADSPSC589_FAMILY__) || defined(__ADSP21569_FAMILY__) || \
	defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)
	INTR_SPORT4_A_DMA, INTR_SPORT4_B_DMA, INTR_SPORT5_A_DMA,
	INTR_SPORT5_B_DMA, INTR_SPORT6_A_DMA, INTR_SPORT6_B_DMA,
...
struct sSPORT {
	...
	_Addr_t __IO *pREG_DMA_ADDRSTART;
	_Addr_t __IO *pREG_DMA_DSCPTR_NXT;
...
{
	volatile uint32_t DMA_STAT = *sport->pREG_DMA_STAT;
	// Reset SPORT and DMA channels
	*sport->pREG_SPORT_CTL = 0;
	*sport->pREG_SPORT_MCTL = 0;
	*sport->pREG_SPORT_CS0 = 0;
	*sport->pREG_DMA_CFG = 0;
	*sport->pREG_DMA_STAT = DMA_STAT;
	*sport->pREG_DMA_DSCPTR_NXT = 0;
}

static inline void sport_flush_buffer(sSPORT *sport, uint8_t *dataAddr,
				      uint32_t dataSizeBytes, int invalidate,
				      bool force)
{
	if (!force && !sport->dataBuffersCached) {
		return;
	}
	flush_data_buffer(dataAddr, dataAddr + dataSizeBytes, invalidate);
}

#if !defined(__ADSPARM__)
static inline void *local_to_system_addr(void *x)
{
	if (((uint32_t)x >= SHARC_L1_ADDR_START) &&
	    ((uint32_t)x <= SHARC_L1_ADDR_END)) {
...
SPORT_SIMPLE_RESULT sport_start(sSPORT *sport, bool flush)
{
	...
	if (!sport->running) {
		...
		if ((flush) && (sport->dataDir == SPORT_SIMPLE_DATA_DIR_TX)) {
			dataAddr = (void *)((uintptr_t)sport->dmaDescriptors[0]
						    .start);
			/* Translate the system address back to the local address */
			dataAddr = system_to_local_addr(dataAddr);
			sport_flush_buffer(sport, dataAddr,
					   sport->dataSizeBytes,
					   ADI_FLUSH_DATA_NOINV,
					   SPORT_SIMPLE_NO_FORCE_FLUSH);
			dataAddr = (void *)((uintptr_t)sport->dmaDescriptors[1]
						    .start);
			/* Translate the system address back to the local address */
			dataAddr = system_to_local_addr(dataAddr);
			sport_flush_buffer(sport, dataAddr,
		...
		*sport->pREG_DMA_DSCPTR_NXT =
			(_Addr_t)sport->dmaDescriptors[1].next;
...
SPORT_SIMPLE_RESULT sport_init(void)
{
	...
	for (port1 = SPORT0A; port1 < SPORT_END; port1++) {
		sport_close = &sportContext[port1];
		sport_stop(sport_close);
	}
...
#if defined(ADI_CORE_SHARC1)
			if ((coreId == ADI_CORE_SHARC0) ||
			    (coreId == ADI_CORE_SHARC1))
#else
			if (coreId == ADI_CORE_SHARC0)
#endif
			{
				*sport->pREG_SPU_SECUREP &=
					~BITM_SPU_SECUREP_MSEC;
			}
		}
	}
...
uint32_t sport_buffer_size(SPORT_SIMPLE_CONFIG *config)
{
	...
	serializers = 0;
	serializers += (config->dataEnable & SPORT_SIMPLE_ENABLE_PRIMARY) ? 1 :
									    0;
	serializers +=
		(config->dataEnable & SPORT_SIMPLE_ENABLE_SECONDARY) ? 1 : 0;
					    ...
					    SPORT_SIMPLE_CONFIG *config)
{
	...
	sport->dmaDescriptors[0].next = (uint32_t)((
		uintptr_t)local_to_system_addr(&sport->dmaDescriptors[1]));
	sport->dmaDescriptors[0].start = (uint32_t)((
		uintptr_t)local_to_system_addr(config->dataBuffers[0]));
	sport->dmaDescriptors[1].next = (uint32_t)((
		uintptr_t)local_to_system_addr(&sport->dmaDescriptors[0]));
	sport->dmaDescriptors[1].start = (uint32_t)((
		uintptr_t)local_to_system_addr(config->dataBuffers[1]));

	/* Flush the DMA descriptors to memory */
	sport_flush_buffer(sport, (uint8_t *)sport->dmaDescriptors,
			   sizeof(sport->dmaDescriptors), ADI_FLUSH_DATA_NOINV,
			   SPORT_SIMPLE_FORCE_FLUSH);
					      ...
					      SPORT_SIMPLE_CONFIG *config)
{
	...
	mctl = (1 << BITP_SPORT_MCTL_A_MCE) | (1 << BITP_SPORT_MCTL_A_MCPDE);
...
SPORT_SIMPLE_RESULT sport_configure(sSPORT *sport, SPORT_SIMPLE_CONFIG *config)
{
	SPORT_SIMPLE_RESULT result = SPORT_SIMPLE_SUCCESS;
	...
	if ((config->dataBuffers[0] == NULL) ||
	    (config->dataBuffers[1] == NULL) || (config->frames == 0)) {
		return (SPORT_SIMPLE_CFG_ERROR);
	}
...
static void sport_dma_irq(uint32_t id, void *usrPtr)
{
	...
	*sport->pREG_DMA_STAT |= ENUM_DMA_STAT_IRQDONE;
	...
	if (sport->callBack) {
		...
		dataAddr =
			(uint8_t *)((uintptr_t)sport->dmaDescriptors[sport->pp]
					    .start);
         ...
         */
		sport->pp = (*sport->pREG_DMA_ADDRSTART ==
			     (_Addr_t)sport->dmaDescriptors[0].start) ?
				    0 :
				    1;
	}
}
